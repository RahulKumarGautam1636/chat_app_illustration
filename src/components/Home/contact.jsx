                            ...
                            <div className="contact__form">
                                <div className="input__fields">
                                    <div className="input__group">
                                        ...
                                        <input type="text" placeholder="Rahul Kumar" id="fName" required/>
                                    </div>
                                    <div className="input__group">
                                    ...
                                    <div className="input__group">
                                        ...
                                        <input type="text" placeholder="xxxxxxxxxx" id="phone" required/>
                                    </div>
                                </div>
                                ...
                                <div className="text__area">
                                    <div className="input__group">
                                        ...
                                        <textarea name="message" id="message" rows="1" placeholder="Write your message here" required></textarea>
                                    </div>
                                </div>
